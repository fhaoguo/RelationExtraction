...
np.save('ckpt/{}_p.npy'.format(args.result), result['np_prec'])
np.save('ckpt/{}_r.npy'.format(args.result), result['np_rec'])
json.dump(result['max_micro_f1_each_relation'], open('ckpt/{}_mmicrof1_rel.json'.format(args.result), 'w'), ensure_ascii=False)
