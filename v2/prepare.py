...
if __name__ == "__main__":
    init(train_file_name="../data/DuNRE/train_nre.json",
         test_file_name="../data/DuNRE/dev_nre.json",
         rel2id_file_name="../data/DuNRE/relation_nre.json",
         word_vec_file_name="../data/DuNRE/word_dictionary_nre.json",
         save_dir="_data",
         max_length=120)
