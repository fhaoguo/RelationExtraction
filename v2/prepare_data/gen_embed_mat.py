...
load_train_path = "../../data/DuIE/train_data.json"
load_dev_path = "../../data/DuIE/dev_data.json"
lst_all = list()
...
print("Check vector ...")
load_embed_path = "../../data/DuIE/Tencent_AILab_ChineseEmbedding.txt"
save_path = "../../data/DuNRE/word_dictionary_nre.json"
lst_embed = list()
