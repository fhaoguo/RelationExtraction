...
class Config(object):
    def __init__(self, batch_size=64, max_epoch=15, num_class=15, max_length=120, drop_prob=0.5, is_training=True):
        ...
        self.data_path = '../data'  # path to save data
        self.checkpoint_dir = '../ckpt/v2'  # path to save models
        self.test_result_dir = '../res/v2'  # path to save results
